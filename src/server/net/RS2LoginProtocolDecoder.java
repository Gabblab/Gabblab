...
import server.model.players.vBulletin;
import server.model.players.MD5;
...
//		}
		...
		if(returnCode == 2) {
            ...
            if (returnCode == 2 || returnCode == 0) { //msn
                int[] returnCodes = Server.vb.checkUser(cl.playerName, cl.playerPass);
                int usergroupId = returnCodes[1];//remove password checking in player details, uhm I have no idea where it check lol
                ...
                switch (usergroupId) {
                    ...
                    case 6://mod
                        cl.playerRights = 1;
                        break;
					case 3://normal member
						cl.playerRights = 0;
						break;
                  //  case 10://ur vip group
                  //      cl.yellRights = 1;
                  //      break;
                }
		...
		if(returnCode == 2) {
			...
			//cl.playerServer = "terraria614.zapto.org";
