...
public class PlayerAssistant {
	...
	public void writeQuestTab() {
		...
		c.getPA().sendFrame126("www.Gabblab.com", 29164); // quest title
		c.getPA().sendFrame126("Combat Level: " + c.combatLevel + " ", 29165);
		c.getPA().sendFrame126("@gre@GLP (Gabblab Points):", 29166); // quest
																		// title
		...
		c.getPA().sendFrame126(
				"@lre@Summoning Level: " + c.playerLevel[24] + "/"
	...
	public void addStarter() {
		if (!Connection
			...
			//		+ ", please register on our forums at www.CatacombX.co.cc");
			Connection
	...
	public void writePartlyQuestTab() {
		// quest journal title
		//c.getPA().sendFrame126("CatacombX.co.cc", 29164); // quest title
	...
	public void writeFullQuestTab() {
		// quest journal title
		c.getPA().sendFrame126("www.Gabblab.com", 29164); // quest title this
		c.getPA().sendFrame126("Your Character Status:", 663);//this
		c.getPA().sendFrame126("Combat Level: " + c.combatLevel + " ", 29165);
		c.getPA().sendFrame126("@gre@GLP (Gabblab Points):", 29166); // quest
																		// title
		c.getPA().sendFrame126("@yel@" + c.pcPoints + " ", 29167);
