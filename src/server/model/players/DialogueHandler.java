package server.model.players;//new
...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		break;
		case 205:
			sendNpcChat4("Hello there "+c.playerName+"!"," I am Thok, master of ALL Dungeoneers.","Welcome to Dungeoneering!","What can I help you with?", c.talkingNpc, "Thok, the Dungeoneer.");
			c.nextChat = 206;
		break;
		case 206:
			sendOption4("", "How do I Dungeoneer?", "Where can I spend points?", "That's all, thanks.");
		c.dialogueAction = 206;
		c.dialogueId = 206;
			break;
		case 207:
			sendNpcChat2("Easy! Kill the NPC's.", "You will recieve points from killing them.",c.talkingNpc, "Thok, the master Dungeoneer.");
			c.nextChat = 206;
		break;
		case 208:
			sendNpcChat2("Easy! Kill the NPC's.","You will recieve points from them.",c.talkingNpc, "Thok, the master Dungeoneer.");
			c.nextChat = 206;
		break;
		case 209:
			sendNpcChat3("Talk to the trader.", "He will have something for you.", "He is always interested in trading things.",c.talkingNpc, "Thok, the master Dungeoneer.");
			c.nextChat = 206;
		break;
		case 210:
			sendNpcChat2("Alright then "+c.playerName+".","Have fun Dungeoneering!",c.talkingNpc, "Thok, the master Dungeoneer.");
