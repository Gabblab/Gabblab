...
if(itemName.contains("cloak") || itemName.contains("attractor") || itemName.contains("Veteran Cape") || itemName.contains("Max Cape") || itemName.contains("Completionist Cape") || itemName.contains("accumulator") || itemName.contains("cape") || itemName.contains("Cape") || itemName.contains("cloak") || itemName.contains("Cloak") || itemType(wearID).equalsIgnoreCase("cape")) {
					targetSlot=1;
				} else if(itemType(wearID).equalsIgnoreCase("Veteran cape") || itemName.contains("Max Cape") || itemName.contains("Completionist Cape")) {
					targetSlot=1;
				} else if(itemType(wearID).equalsIgnoreCase("hat") || itemName.contains("cap") && !itemName.contains("cape") || itemName.contains("headdress") || itemName.contains("cavalier") || itemName.contains("Max Hood") || itemName.contains("Veteran hood") || itemName.contains("Completionist hood") || itemName.contains("Cavalier") || itemName.contains("sallet") || itemName.contains("Sallet") || itemName.contains("Hat") && !itemName.contains("Hatchet")  || itemName.contains("mask") || itemName.contains("Mask") || itemName.contains("hat") && !itemName.contains("hatchet") || itemName.contains("helm") || itemName.contains("Helm") || itemName.contains("hood") || itemName.contains("Hood") || itemName.contains("berret") || itemName.contains("afro")) {
					targetSlot=0;
					...
					targetSlot=13;
				} else if(itemType(wearID).equalsIgnoreCase("body") || itemName.contains("platemail") || itemName.contains("chest") && !itemName.contains("anchor") || itemName.contains("Torso") || itemName.contains("platebody") || itemName.contains("Platebody") || itemName.contains("chain") && !itemName.contains("skirt")  || itemName.contains("Chain") || itemName.contains("Top") || itemName.contains("Hauberk") || itemName.contains("hauberk") || itemName.contains("top") || itemName.contains("torso") || itemName.contains("shirt") || itemName.contains("Shirt") || itemName.contains("body") || itemName.contains("Body") || itemName.contains("coat") || itemName.contains("Investigator's coat")){
					targetSlot=4;
				} else if(itemType(wearID).equalsIgnoreCase("shield") || itemName.contains("Book") || itemName.contains("Toktz-xil-ul") || itemName.contains("book") || itemName.contains("Shield") || itemName.contains("shield") || itemName.contains("defender") || itemName.contains("Defender")) {
					targetSlot=5;
				} else if(itemType(wearID).equalsIgnoreCase("legs") || itemName.contains("Cuisse") || itemName.contains("cuisse") || itemName.contains("chaps") || itemName.contains("Chaps") || itemName.contains("legs") || itemName.contains("Legs") || itemName.contains("Bottom") || itemName.contains("bottom") || itemName.contains("skirt") || itemName.contains("Skirt") || itemName.contains("shorts") || itemName.contains("Shorts") || itemName.contains("blouse") || itemName.contains("Blouse") || itemName.contains("tasset") || itemName.contains("Tasset") || itemName.contains("leg") || itemName.contains("Leg") || itemType(wearID).equalsIgnoreCase("legs") || itemName.equalsIgnoreCase("Void_knight_robe") || itemName.equalsIgnoreCase("Void knight robe")) {
					targetSlot=7;
				...
				if(Config.itemRequirements) {
					if(targetSlot == 10 || targetSlot == 7 || targetSlot == 5 || targetSlot == 4 || targetSlot == 0 || targetSlot == 9 || targetSlot == 10) {
						...
						if(c.hpLevelReq > 0) {
							if(c.getPA().getLevelForXP(c.playerXP[3]) < c.hpLevelReq) {
								c.sendMessage("You need a hitpoints level of "+c.hpLevelReq+" to wear this item.");
								canWearItem = false;
							}
						}
						if(c.Donatorreq > 0) {
					...
					if(targetSlot == 3) {
						if(c.strengthLevelReq > 0) {
							if(c.getPA().getLevelForXP(c.playerXP[2]) < c.strengthLevelReq) {
								c.sendMessage("You need a strength level of "+c.strengthLevelReq+" to weild this item.");
								canWearItem = false;
							}
						}
						if(c.Donatorreq > 0) {
							if(c.isDonator < 1) {
								c.sendMessage("You need to be a donator to weild this.");
								canWearItem = false;
							}
						}
